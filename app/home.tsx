...
export default function HomeScreen() {
    ...
    const setupNotifications = async () => {
        try {
            ...
            if (!token) {
                console.log("Falha ao obter token de notificação push");
                return;
            }
    ...
    const handleTakeDose = async (medication: Medication) => {
        try {
            ...
            console.error("Erro ao registrar a dose:", error);
                    ...
                    {todaysMedications.length === 0 ? (
                        <View style={styles.emptyState}>
                            ...
                            <Text style={styles.emptyStateText}>
                                Não há medicamentos agendados para hoje
                            </Text>
                                    ...
                                    {taken ? (
                                        <View style={[styles.takenBadge]}>
                                            <Ionicons
                                                ...
                                                color="#4CAF50"
                                            />
                                            <Text style={styles.takenText}>Coletado</Text>
                                        </View>
                                    ) : (
                                        <TouchableOpacity
                                            style={[
                                        ...
                                        >
                                            <Text style={styles.takeDoseText}>Coletar</Text>
                                        </TouchableOpacity>
                                    )}
                                </View>
                            );
