...
export default function RefillTrackerScreen() {
    ...
    const handleRefill = async (medication: Medication) => {
        try {
            ...
            Alert.alert(
                "Recarga registrada",
                `${medication.name} foi reabastecido para ${medication.totalSupply} unidades.`
            );
        } catch (error) {
            console.error("Erro ao gravar recarga:", error);
            Alert.alert("Erro", "Falha ao registrar recarga. Tente novamente.");
        }
    };
        ...
        <View style={styles.container}>
            ...
            <View style={styles.content}>
                <View style={styles.header}>
                    ...
                    <Text style={styles.headerTitle}>Rastreador de recarga</Text>
                </View>
                ...
                >
                    {medications.length === 0 ? (
                        <View style={styles.emptyState}>
                            ...
                            <Text style={styles.emptyStateText}>Não há medicamentos para rastrear</Text>
                            <TouchableOpacity
                                ...
                                <View key={medication.id} style={styles.medicationCard}>
                                    ...
                                    <View style={styles.supplyContainer}>
                                        <View style={styles.supplyInfo}>
                                            <Text style={styles.supplyLabel}>Fornecimento Atual</Text>
                                    ...
                                    >
                                        <Text style={styles.refillButtonText}>Recarga de registro</Text>
                                    </TouchableOpacity>
                                </View>
                            );
                        })
