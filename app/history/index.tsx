...
export default function HistoryScreen() {
    ...
    const handleClearAllData = () => {
        Alert.alert(
            ...
            "Tem certeza de que deseja limpar todos os dados de medicamentos? Esta ação não pode ser desfeita.",
            [
                {
                    text: "Cancelar",
                    style: "cancel",
                },
                {
                    ...
                    onPress: async () => {
                        try {
                            ...
                            Alert.alert("Erro", "Falha ao limpar os dados. Tente novamente.");
                        }
                    },
                },
            ]
        ...
        <View style={styles.container}>
            ...
            <View style={styles.content}>
                <View style={styles.header}>
                    ...
                    <Text style={styles.headerTitle}>Registro de histórico</Text>
                </View>
                ...
                >
                                ...
                                <View key={dose.id} style={styles.historyCard}>
                                    ...
                                    <View style={styles.medicationInfo}>
                                        <Text style={styles.medicationName}>
                                            {dose.medication?.name || "Medicação Desconhecida"}
                                        </Text>
                                        <Text style={styles.medicationDosage}>
                                            {dose.medication?.dosage}
                                        </Text>
                                        <Text style={styles.timeText}>
                                            {new Date(dose.timestamp).toLocaleTimeString("pt-BR", {
                                                hour: "2-digit",
                                                minute: "2-digit",
                                            })}
                                        </Text>
                    ...
                    <View style={styles.clearDataContainer}>
                        ...
                        >
                            ...
                            <Text style={styles.clearDataText}>Limpar todos os dados</Text>
                        </TouchableOpacity>
                    </View>
                </ScrollView>
            </View>
