...
const FREQUENCIES = [
    ...
    {
        id: "2",
        label: "Duas vezes ao dia",
        icon: "sync-outline" as const,
        times: ["09:00", "21:00"],
    },
    {
        id: "3",
        label: "Três vezes ao dia",
        icon: "time-outline" as const,
        times: ["09:00", "15:00", "21:00"],
    },
    {
        id: "4",
        label: "Quatro vezes ao dia",
        icon: "repeat-outline" as const,
        times: ["09:00", "13:00", "17:00", "21:00"],
    },
    { id: "5", label: "Conforme necessário", icon: "calendar-outline" as const, times: [] },
];
...
const DURATIONS = [
    ...
    { id: "5", label: "Em andamento", value: -1 },
];
...
export default function AddMedicationScreen() {
    ...
    const validateForm = () => {
        ...
        if (!form.dosage.trim()) {
            newErrors.dosage = "A dosagem é necessária";
        }
        ...
        if (form.refillReminder) {
            if (!form.currentSupply) {
                newErrors.currentSupply =
                    "O fornecimento atual é necessário para rastreamento de recarga";
            }
            if (!form.refillAt) {
                newErrors.refillAt = "O limite de alerta de recarga é obrigatório";
            }
            if (Number(form.refillAt) >= Number(form.currentSupply)) {
                newErrors.refillAt = "O alerta de recarga deve ser menor que o fornecimento atual";
            }
        }
    ...
    const handleSave = async () => {
        try {
            ...
            Alert.alert(
                "Error",
                "Falha ao salvar medicação. Por favor, tente novamente.",
                [{ text: "OK" }],
                { cancelable: false }
            );
        } finally {
        ...
        <View style={styles.container}>
            ...
            <View style={styles.content}>
                ...
                >
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={styles.inputContainer}>
                            <TextInput
                                ...
                                placeholder="Dosagem (por exemplo, 500 mg)"
                                placeholderTextColor="#999"
                                value={form.dosage}
                                onChangeText={(text) => {
                    ...
                    {/* Schedule */}
                    <View style={styles.section}>
                        <Text style={styles.sectionTitle}>Com que frequência?</Text>
                        {errors.frequency && (
                        ...
                        {form.frequency && form.frequency !== "Conforme necessário" && (
                            <View style={styles.timesContainer}>
                                <Text style={styles.timesTitle}>Medicaçaões</Text>
                                ...
                                <View style={styles.switchLabelContainer}>
                                    ...
                                    <View>
                                        ...
                                        <Text style={styles.switchSubLabel}>
                                            Seja notificado quando chegar a hora de tomar seu medicamento
                                        </Text>
                                    </View>
                                </View>
                                <Switch
                        ...
                        <View style={styles.card}>
                            <View style={styles.switchRow}>
                                <View style={styles.switchLabelContainer}>
                                    ...
                                    <View>
                                        <Text style={styles.switchLabel}>Rastreamento de recarga</Text>
                                        <Text style={styles.switchSubLabel}>
                                            Seja notificado quando necessitar de abastecimento
                                        </Text>
                                    </View>
                                </View>
                                <Switch
                                    ...
                                    <View style={styles.inputRow}>
                                        <View style={[styles.inputContainer, styles.flex1]}>
                                            <TextInput
                                                ...
                                                placeholder="Fornecimento Atual"
                                                placeholderTextColor="#999"
                    ...
                    <View style={styles.section}>
                        <View style={styles.textAreaContainer}>
                            <TextInput
                                ...
                                placeholder="Adicione notas ou instruções especiais..."
                                placeholderTextColor="#999"
                                value={form.notes}
