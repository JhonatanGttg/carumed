            ...
            const auth = await LocalAuthentication.authenticateAsync({
                promptMessage:
                    hasHardware && hasBiometrics
                        ...
                        : "Digite seu PIN para acessar o CaruMed",
    ...
    return (
        <LinearGradient colors={["#4CAF50", "#2E7D32"]} style={styles.container}>
            <View style={styles.content}>
                ...
                <Text style={styles.title}>CaruMed</Text>
                <Text style={styles.subtitle}>Seu assistente pessoal de medicação</Text>
                ...
                <View style={styles.card}>
                    ...
                    <Text style={styles.instructionText}>
                        {hasBiometrics
                            ...
                            : "Digite seu PIN para acessar seus medicamentos"}
                    </Text>
